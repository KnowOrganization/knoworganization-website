			...
			<div className="relative">
				...
				<ul className="my-10 grid grid-cols-1 md:grid-cols-2">
					<li className=" md:text-4xl text-2xl font-montserrat font-light my-10 md:px-20 px-5  py-3 md:w-40v border-gray-500 border-2 rounded-3xl relative ">
						...
						<p className=" text-lg md:px-20 px-5 py-5">
							Tailored Solutions for Your Unique Vision: Elevate Your
							Business with Custom Software Development.
						</p>
						<span className=" absolute bottom-0 left-0 h-20 md:w-96 w-52 bg-gradient-to-tr from-primary to-purple-500 blur-3xl opacity-60"></span>
					</li>
					<li className=" text-4xl font-montserrat font-light my-10 md:px-20 px-5 py-3  md:w-40v border-gray-500 border-2 rounded-3xl relative ">
						<span className=" absolute right-0 h-20 md:w-96 w-36 bg-gradient-to-tr from-primary to-teal-500 blur-3xl"></span>
					...
					<li className=" text-4xl font-montserrat font-light my-10 pmd:x-20  px-5 py-3  md:w-40v border-gray-500 border-2 rounded-3xl relative ">
						<span className=" absolute right-0 h-20 md:w-96 w-36 bg-gradient-to-tr from-primary to-teal-500 blur-3xl"></span>
						<span className="  py-2   ">
